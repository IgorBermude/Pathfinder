...
class MapaBottomSheetFragment : BottomSheetDialogFragment() {
    ...
    override fun onCreateView(
        ...
        Picasso.get().load(R.drawable.standardmap_image).into(view.findViewById<ImageView>(R.id.standard_image))
        Picasso.get().load(R.drawable.streetsmap_image).into(view.findViewById<ImageView>(R.id.streets_image))
        Picasso.get().load(R.drawable.satelitemap_image).into(view.findViewById<ImageView>(R.id.satelite_image))
        Picasso.get().load(R.drawable.darkmap_image).into(view.findViewById<ImageView>(R.id.dark_image))
        // Falta deixar as bordas arredondadas das imagens
